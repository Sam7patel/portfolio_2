      ...
      <div className="container">
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            <a href="https://www.linkedin.com/in/samarth-patel-796571222?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="button" target="_blank" rel="noopener noreferrer">
